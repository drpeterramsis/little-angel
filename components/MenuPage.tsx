  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] p-6 gap-6 animate-fade-in">
      ...
      >
        ...
        <div className="relative flex flex-row-reverse items-center justify-between gap-6">
           <div className="flex flex-col items-end">
             <span className="text-3xl font-black text-zinc-900 dark:text-white font-sans tracking-tight">Little Angel</span>
             <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300 mt-1">فريق الكورال</span>
           </div>
           <div className="w-24 h-24 rounded-full bg-white dark:bg-zinc-800 shadow-lg border-2 border-white/50 flex-shrink-0 overflow-hidden p-1">
      ...
      >
        ...
        <div className="relative flex flex-row-reverse items-center justify-between gap-6">
           <div className="flex flex-col items-end">
             <span className="text-3xl font-black text-zinc-900 dark:text-white font-sans tracking-tight">ترانيم الكورال</span>
             <span className="text-sm font-medium text-zinc-700 dark:text-zinc-300 mt-1">كلمات و ألحان</span>
           </div>
           <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-300 to-orange-400 shadow-lg border-2 border-white/50 flex-shrink-0 flex items-center justify-center text-white">
             <Music size={48} />
           </div>
        </div>
      </button>
