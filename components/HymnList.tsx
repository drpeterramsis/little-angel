      ...
      <div className="sticky top-20 z-40 mb-6">
        <div className="relative shadow-lg rounded-2xl">
          <input
            ...
            className="w-full px-12 py-4 bg-white dark:bg-zinc-800 rounded-2xl border-2 border-transparent focus:border-primary outline-none transition-all text-lg placeholder:text-zinc-400 dark:text-white"
          />
        ...
        {hymns.length === 0 ? (
          ...
          hymns.map((hymn) => (
            <div
              ...
              className="group bg-white dark:bg-zinc-900 p-5 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-800 hover:border-primary/50 dark:hover:border-primary/50 cursor-pointer transition-all hover:shadow-md transform hover:-translate-y-0.5"
            >
              <div className="flex justify-between items-center">
                ...
                <ChevronLeft className="text-zinc-300 dark:text-zinc-700 group-hover:text-primary transition-colors" />
              </div>
              
              {/* Show snippet if lyrics matched */}
              {searchTerm && hymn.lyrics.toLowerCase().includes(searchTerm.toLowerCase()) && (
                <div className="mt-3 mr-14 text-sm text-zinc-500 dark:text-zinc-400 line-clamp-2 leading-relaxed">
                  {highlightText(
